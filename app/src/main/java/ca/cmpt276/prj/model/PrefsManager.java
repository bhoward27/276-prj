...
import static ca.cmpt276.prj.model.Constants.DEFAULT_DIFFERENT_CARDS_AMOUNT;
import static ca.cmpt276.prj.model.Constants.DEFAULT_DRAW_PILE_SIZE;
...
import static ca.cmpt276.prj.model.Constants.DEFAULT_ORDER;
import static ca.cmpt276.prj.model.Constants.DIFFERENT_CARDS_AMOUNT_PREF;
import static ca.cmpt276.prj.model.Constants.DRAW_PILE_SIZE_PREF;
...
import static ca.cmpt276.prj.model.Constants.ORDER_PREF;
...
public class PrefsManager {
	...
	public void saveOrderSelcted(String order){
		SharedPreferences.Editor editor = prefs.edit();
		editor.putString(ORDER_PREF, order);
		editor.apply();
	}

	public void saveDrawPileSizeSelected(String drawPileSize){
		SharedPreferences.Editor editor = prefs.edit();
		editor.putString(DRAW_PILE_SIZE_PREF, drawPileSize);
		editor.apply();
	}

	public void saveDifferentCardsAmountSelected(int differentCards){
		SharedPreferences.Editor editor = prefs.edit();
		editor.putInt(DRAW_PILE_SIZE_PREF, differentCards);
		editor.apply();
	}

	public String getOrderSelected(){
		return prefs.getString(ORDER_PREF, DEFAULT_ORDER);
	}

	public String getDrawPileSizeSelected(){
		return prefs.getString(DRAW_PILE_SIZE_PREF, DEFAULT_DRAW_PILE_SIZE);
	}

	public int getDifferentCardsAmountSelected(){
		return prefs.getInt(DIFFERENT_CARDS_AMOUNT_PREF, DEFAULT_DIFFERENT_CARDS_AMOUNT);
	}
